...
\begin{table}
\begin{center}
\caption{Seasonal Average Precipitation for California and sub-divisions} \label{tab:Table5}
\begin{tabular}{lcccc}
...
\acknowledgments
 ...
 {\color{red}clean up the bibliography a bit}
