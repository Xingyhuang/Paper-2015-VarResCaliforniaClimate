...
\begin{table}
\begin{center}
\caption{RMSE and Bias for winter (DJF) Precipitation (California)} \label{tab:Table6}
\begin{tabular}{lcccc}
\hline \textbf{Pr} & \textbf{CPC}  & \textbf{UW} & \textbf{PRISM} & \textbf{DAYMET} \\
\hline $    $ & RMSE $\     $  Bias & RMSE $\     $  Bias & RMSE $\     $  Bias & RMSE $\     $  Bias \\
...
\end{center}
\caption{Topography fields in meters (m) for (top left to bottom right) varres-CESM 0.25deg, varres-CESM 0.125deg, uniform CESM 0.25deg, WRF 27km, WRF 9km and ERA-Interim $\sim$80km. {\color{red} Need to add a figure showing our 5 climate zones.}} \label{fig:Figure3}
\end{figure}
...
\end{center}
\caption{Annual average daily maximum 2m temperatures (Tmax) from models and reference datasets (unit: $^\circ C$)} \label{fig:Figure4}
\end{figure}
...
\end{center}
\caption{As Figure 4, but for daily minimum 2m temperatures (Tmin)} \label{fig:Figure5}
\end{figure}
...
\end{center}
\caption{As Figure 4, but for daily mean 2m temperatures (Tavg)} \label{fig:Figure6}
\end{figure}
...
\end{center}
\caption{Difference between simulations and PRISM reference data for daily Tavg ($^\circ C$)} \label{fig:Figure7}
\end{figure}
...
\end{center}
\caption{Seasonal cycle of monthly-average Tavg for each subzone ($^\circ C$) Errorbars represent standard deviation ($\sigma$) values. {\color{red} Remove word ``month'' from plots. Change major tickmarks to be at each month.  Change to be January through December}} \label{fig:Figure8}
\end{figure}
...
\end{center}
\caption{As Figure 4, but for summer Tmax.} \label{fig:Figure9}
\end{figure}
...
\end{center}
\caption{As Figure 7 but for summer Tmax RMSE ($^\circ C$).} \label{fig:Figure10}
\end{figure}
...
\end{center}
\caption{Annual average daily total precipitation from models and reference datasets (mm/d). } \label{fig:Figure12}
\end{figure}
...
\end{center}
\caption{Difference between simulations and reference data for total precipitation (mm/d). } \label{fig:Figure13}
\end{figure}
...
\end{center}
\caption{As Figure 8, but for monthly-average total precipitation (mm/d). {\color{red} might need to put these dots on a separate plot.}} \label{fig:Figure14}
\end{figure}
...
\end{center}
\caption{As Figure 12, but for winter (DJF) total precipitation (mm/d).} \label{fig:Figure15}
\end{figure}
