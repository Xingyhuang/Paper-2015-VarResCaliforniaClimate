...
\begin{table}
\begin{center}
\caption{RMSE for annual Temperature} \label{tab:Table2}
\begin{tabular}{lcccc}
...
\begin{table}
\begin{center}
\caption{Bias for annual Temperature} \label{tab:Table3}
\begin{tabular}{lcccc}
...
\begin{table}
\begin{center}
\caption{RMSE and Bias for summer Tmax} \label{tab:Table4}
\begin{tabular}{lcccc}
...
\begin{table}
\begin{center}
\caption{RMSE and Bias for annual Pr} \label{tab:Table5}
\begin{tabular}{lcccc}
...
\end{center}
\caption{Domains of WRF simulations (left: 9km, right: 27km) and topography (unit: m)} \label{fig:Figure1}
\end{figure}
...
\end{center}
\caption{The grid mesh of varres-CESM (left:0.25 degree, right:0.125 degree)} \label{fig:Figure2}
\end{figure}

\begin{figure}
\begin{center}
\includegraphics[angle=90,width=8.5in]{topo.pdf}
\end{center}
\caption{Topography fields in meters (m) for (top left to bottom right) varres-CESM 28km, varres-CESM 14km, uniform CESM 25km, WRF 27km, WRF 9km and ERA-Interim. {\color{red}Use only a single color bar for all plots.  Change 25km to 28km and 12.5km to 14km.}} \label{fig:Figure3}
\end{figure}

\begin{figure}
\begin{center}
\includegraphics[angle=90,width=8.5in]{t2max.pdf}
\end{center}
\caption{Annual average daily maximum 2m temperatures (Tmax) from models and reference datasets (unit: $C$)} \label{fig:Figure4}
\end{figure}

\begin{figure}
\begin{center}
\includegraphics[angle=90,width=8.5in]{t2min.pdf}
\end{center}
\caption{Similar as Fig. 4, but for daily minimum 2m temperatures (Tmin)} \label{fig:Figure5}
\end{figure}

\begin{figure}
\begin{center}
\includegraphics[angle=90,width=8.5in]{t2avg.pdf}
\end{center}
\caption{Similar as Fig.4, but for daily mean 2m temperatures (Tavg)} \label{fig:Figure6}
\end{figure}

\begin{figure}
\begin{center}
\includegraphics[angle=90,width=8.5in]{t2avg_dif.pdf}
\end{center}
\caption{Difference between simulations and reference data for daily Tavg} \label{fig:Figure7}
\end{figure}
...
\end{center}
\caption{Seasonal cycle of monthly-average Tavg for each subzone (unit: $C$) Errorbars represent ? values} \label{fig:Figure8}
\end{figure}
...
\end{center}
\caption{Similar as Fig.4, but for summer Tmax} \label{fig:Figure9}
\end{figure}
...
\end{center}
\caption{Similar as Fig. 7 but for summer Tmax (the number is RMSE value)} \label{fig:Figure10}
\end{figure}
...
\end{center}
\caption{Frequency distribution of summer Tmax constructed from 26 years daily data (unit: $C$)} \label{fig:Figure11}
\end{figure}
...
\end{center}
\caption{Annual average daily precipitation (Pr) from models and reference datasets (unit: mm/d)} \label{fig:Figure12}
\end{figure}
...
\end{center}
\caption{Difference between simulations and reference data for Pr} \label{fig:Figure13}
\end{figure}
...
\end{center}
\caption{Simiarl as Figure 8, but for monthly-average Pr} \label{fig:Figure14}
\end{figure}
...
\end{center}
\caption{Similar as Figure 12, but for winter Pr} \label{fig:Figure15}
\end{figure}
...
\end{center}
\caption{Similar as Figure 13, but for winter Pr} \label{fig:Figure16}
\end{figure}
...
\end{center}
\caption{Frequency distribution of winter Pr constructed from 26 years daily data (unit: mm/d) (note: vertical scale is logarithmic)} \label{fig:Figure17}
\end{figure}
