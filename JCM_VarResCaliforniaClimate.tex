...
\title{High-resolution regional climate modeling evaluation using variable resolution CESM over California}
...
\end{center}
\caption{Topography representations of simulations and ERA-Interim (unit: m)} \label{fig:Figure3}
\end{figure}
