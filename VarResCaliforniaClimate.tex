...
\documentclass[ms,draft]{agutex}   %draft, [ms]
...
\bibitem[{\textit{Cassano et~al.}(2011)\textit{Cassano, Higgins, and
  Seefeldt}}]{cassano2011performance}
...
\bibitem[{\textit{Cayan et~al.}(1998)\textit{Cayan, Dettinger, Diaz, and
  Graham}}]{cayan1998decadal}
...
\bibitem[{\textit{Gettelman et~al.}(2008)\textit{Gettelman, Morrison, and
  Ghan}}]{gettelman2008new}
...
\bibitem[{\textit{Hughes et~al.}(2014)\textit{Hughes, Mahoney, Neiman, Moore,
  Alexander, and Ralph}}]{hughes2014landfall}
...
\bibitem[{\textit{Jankov et~al.}(2009)\textit{Jankov, Bao, Neiman, Schultz,
  Yuan, and White}}]{jankov2009evaluation}
...
\bibitem[{\textit{Leung et~al.}(2003{\natexlab{a}})\textit{Leung, Mearns,
  Giorgi, and Wilby}}]{leung2003regional}
...
\bibitem[{\textit{Leung et~al.}(2003{\natexlab{b}})\textit{Leung, Qian, Bian,
  and Hunt}}]{leung2003hydroclimate2}
Leung, L.~R., Y.~Qian, X.~Bian, and A.~Hunt (2003{\natexlab{b}}), {Hydroclimate
...
\bibitem[{\textit{Liu et~al.}(2012)\textit{Liu, Tsimpidi, Hu, Stone, Russell,
  and Nenes}}]{liu2012differences}
...
\bibitem[{\textit{Morrison and Gettelman}(2008)}]{morrison2008new}
...
\bibitem[{\textit{Sakaguchi et~al.}(2015)\textit{Sakaguchi, Leung, Zhao, Yang,
  Lu, Hagos, Rauscher, Dong, Ringler, and Lauritzen}}]{sakaguchi2015exploring}
...
\bibitem[{\textit{Wehner et~al.}(2010)\textit{Wehner, Smith, Bala, and
  Duffy}}]{wehner2010effect}
...
\bibitem[{\textit{Zarzycki and Jablonowski}(2015)}]{zarzycki2015experimental}
...
\bibitem[{\textit{Zhang and McFarlane}(1995)}]{zhang1995sensitivity}
