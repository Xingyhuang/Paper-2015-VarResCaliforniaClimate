...
\altaffiltext{1}{Department of Land, Air and Water Resources, University of Califonia, Davis}
...
The annual cycle of precipitation averaged over each sub-zone over the simulation period is presented in Figure \ref{fig:trd_pr_allzones}. The values are calculated by taking the average of mean monthly Pr over specific regional zone. The 95\% confidence intervals of UW and PRISM are also depicted indicating statistical significance of differences when simulations are out of these ranges. It can be seen that the simulations exhibit similar trends to the reference datasets with highest precipitation over winter and lowest values over summer. The main deviation occurred during the rainy seasons, especially in winter. WRF 27km is drier than PRISM and UW with relative differences ranging from $\sim$10$\%$-40$\%$, whereas WRF 9km is far wetter with relative differences reaching up to 40$\%$-80$\%$ over these five climate sub-zones. Varres-CESM tracks well with observed precipitation with $\sim$10$\%$-20$\%$ relative difference everywhere except in the CV, where precipitation is overestimated at rainy seasons with about 70$\%$-80$\%$. From the MWW test, the varres-CESM and WRF 27km are not significantly different from reference datasets in most regions, except over CV's late winter to spring for varres-CESM 0.25$^\circ$ and NC's winter to spring and DR's winter for WRF 27km. WRF 9km is different from reference datasets over most regions, except over DR and SC's winter and spring.
